...
BOOST_AUTO_TEST_CASE(util_GetArg)
{
    ...
    BOOST_CHECK_EQUAL(GetArg("inttest1", -1), 16688);
...
BOOST_AUTO_TEST_CASE(util_FormatMoney)
{
    ...
    BOOST_CHECK_EQUAL(FormatMoney((COIN/10000)*166886789, false), "16688.6789");
...
BOOST_AUTO_TEST_CASE(util_ParseMoney)
{
    ...
    BOOST_CHECK(ParseMoney("16688.6789", ret));
    BOOST_CHECK_EQUAL(ret, (COIN/10000)*166886789);
