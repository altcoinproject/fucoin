...
const string strMessageMagic = "fucoin Signed Message:\n";
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal fucoin miner
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in fucoin
    bool fStrictPayToScriptHash = true; // Always active in fucoin
    ...
    // ppcoin: fees are not collected by miners as in fucoin
...
bool CBlock::CheckBlock(bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    //0000003d661e60ebc84bb4cdff627a7b678008f25b5f082199758a9719a6ec40
       ...
       if(GetHash() == uint256("0x000000258ab3a74fe10ec8df4f4efa26d3a57651e99b695b529a0f1b12379cc1"))
           return error("CheckBlock() :Hash == 0x000000258ab3a74fe10ec8df4f4efa26d3a57651e99b695b529a0f1b12379cc1");
        // --- patch end
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "fucoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "Boeing 777 wreckage -- likely from MH370 -- found in Mozambique";
        CTransaction txNew;
        ...
        if (false && (block.GetHash() != hashGenesisBlock)) {
            ...
            // creating a different genesis genesis:
        ...
        assert(block.hashMerkleRoot == uint256("0x916d44207bd5e176f58c7a9988389c70146a5e24ddc541fe093e881f1797efdf"));
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    if (hash > hashTarget && pblock->IsProofOfWork())
        return error("fucoinMiner : proof-of-work not meeting target");
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("fucoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(NULL, pblock))
            return error("fucoinMiner : ProcessBlock, block not accepted");
    }

    return true;
}

void static ThreadfucoinMiner(void* parg);

static bool fGenerateBitcoins = false;
static bool fLimitProcessors = false;
static int nLimitProcessors = -1;

void fucoinMiner(CWallet *pwallet, bool fProofOfStake)
{
    ...
    while (fGenerateBitcoins || fProofOfStake)
    {
        ...
        printf("Running fucoinMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
...
void static ThreadfucoinMiner(void* parg)
{
    ...
    try
    {
        ...
        fucoinMiner(pwallet, false);
        vnThreadsRunning[THREAD_MINER]--;
    }
    catch (std::exception& e) {
        vnThreadsRunning[THREAD_MINER]--;
        PrintException(&e, "ThreadfucoinMiner()");
    } catch (...) {
        vnThreadsRunning[THREAD_MINER]--;
        PrintException(NULL, "ThreadfucoinMiner()");
    }
    nHPSTimerStart = 0;
    if (vnThreadsRunning[THREAD_MINER] == 0)
        dHashesPerSec = 0;
    printf("ThreadfucoinMiner exiting, %d threads remaining\n", vnThreadsRunning[THREAD_MINER]);
}
...
void GenerateBitcoins(bool fGenerate, CWallet* pwallet)
{
    ...
    if (fGenerate)
    {
        ...
        printf("Starting %d fucoinMiner threads\n", nAddThreads);
        for (int i = 0; i < nAddThreads; i++)
        {
            if (!NewThread(ThreadfucoinMiner, pwallet))
                printf("Error: NewThread(ThreadfucoinMiner) failed\n");
            Sleep(10);
        }
    }
}
